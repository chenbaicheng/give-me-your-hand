...
<div id="managerDialog" class="easyui-dialog" title="菜品管理" style="width:650px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" id="gimg" name="good.img"/>
<!--         <input id="sid" name="good.sid" value="1" type="hidden" style="width:200px;word-wrap: break-word;word-break:break-all;" />
        <input id="shop" name="good.shop" type="hidden" value="网上点餐"/> -->
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            ...
            <tr>
                <th width="30%" align="right"><label>主要食材：</label></th>
                <td width="30%">
                    <input id="shicai" name="good.shicai" class="easyui-validatebox"
                           style="width:200px;word-wrap: break-word;word-break:break-all;" type="text" required="true"
                           validType="length[0,100]"/>
                </td>
                <th width="30%" align="right"><label>推荐人群：</label></th>
                <td width="30%">
                    <select name="sick">
			...
			<tr>
                <th width="30%" align="right"><label>所属餐厅：</label></th>
