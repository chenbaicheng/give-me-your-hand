    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '用户', width: 50, field: 'username', sortable: true},
                {title: '内容', width: 200, field: 'note',sortable: true},
                {title: '时间', width: 50, field: 'ndate',sortable: true}
            ]
        ]
         , toolbar: [
           /*  {
...
function deleteItem(uuid) {
    openBackGround();
    $.post("<%=__APP__%>/Replay!deleteItem", {id: uuid}, function (data) {
        closeBackGround();
        closeFlush();
    });
}
