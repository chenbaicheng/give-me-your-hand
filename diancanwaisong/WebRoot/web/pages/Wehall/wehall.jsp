...
/* function dzDetail(data){
    ...
    $("#mendianselect2").text("商家:" + data.shopname);
...
<div data-role="page" id="diancan">
    <div data-role="header" data-position="fixed">
        ...
        <!--<a href="javascript:addClass();" data-rel="button"  class="ui-btn ui-btn-inline ui-icon-bars ui-btn-icon-left ui-btn-right">我的订单</a>-->
    </div>
